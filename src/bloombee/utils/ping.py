...
from bloombee.utils.hivemind_compat import DHT, DHTNode, PeerID, TimedStorage, get_dht_time
...
class PingAggregator:
    def __init__(self, dht: DHT, *, ema_alpha: float = 0.2, expiration: float = 300):
        self.dht = dht
