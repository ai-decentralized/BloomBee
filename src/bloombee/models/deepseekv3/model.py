...
class DistributedDeepseekV3Model(DefaultRevisionMixin, FromPretrainedMixin, PTuneMixin, DeepseekV3Model):
    ...
    def __init__(self, config: DistributedDeepseekV3Config, *, dht: Optional[DHT] = None):
